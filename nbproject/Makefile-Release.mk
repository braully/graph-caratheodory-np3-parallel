...
${OBJECTDIR}/GraphCNP3Main.o: GraphCNP3Main.cu 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphCNP3Main.o GraphCNP3Main.cu

${OBJECTDIR}/GraphCaratheodoryNumber.o: GraphCaratheodoryNumber.cu 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GraphCaratheodoryNumber.o GraphCaratheodoryNumber.cu
